...
namespace TPC
{
    public class IKHandler : MonoBehaviour
    {
        ...
        private void HandleLeftHandIKWeight()
        {
            ...
            leftHandIKWeight = Mathf.Lerp(leftHandIKWeight, targetLHWeight,  multiplier);
        }
        ...
        private void HandleRightHandIKWeight()
        {
            ...
            rightHandIKWeight = Mathf.Lerp(rightHandIKWeight, targetRHWeight,  multiplier);
        }
        ...
        {
            aimHelper.position = Vector3.Lerp(aimHelper.position, states.aimPosition,  5);
        ...
        private void OnAnimatorIK(int layerIndex)
        {
            ...
            Vector3 filterDirection = states.aimPosition;
